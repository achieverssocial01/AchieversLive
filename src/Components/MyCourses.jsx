    ...
    return (
        <>
            {user?.products?.length > 0 ? (
                ...
                <div className="bg-[#000000] flex justify-center items-center p-[71px] md:p-0  min-h-[calc(100vh-41px)] md:min-h-[calc(100vh-112px)]">
                    <div className="bg-[#1A1C24] md:w-[412px] mx-[51px] md:mx-auto flex flex-col gap-2 md:gap-[25px] px-4 py-[16px]  md:py-[27px] h-fit absolute top-0 left-0 right-0 bottom-0 m-auto rounded-md   text-center">
                        ...
                        <Link
                            to="/all-courses"
                            className="w-full p-3 text-base rounded-full bg-[#4B006E] leading-5 font-semibold text-white"
                        >
                            Explore
                        </Link>
                    </div>
